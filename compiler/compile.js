...
const fullLibraryConfig = JSON.parse(fs.readFileSync('./compile-config-full.json', {encoding: 'utf8'}));
const decodeLibraryConfig = JSON.parse(fs.readFileSync('./compile-config-decompress.json', {encoding: 'utf8'}));
